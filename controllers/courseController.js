...
exports.deleteCourse = async (req, res) => {
  try {
    ...
    console.error("🔥 Delete course error:", error.message, error.stack);
    res
      .status(500)
      .json({ error: "Failed to delete course", details: error.message });
  }
...
exports.renameAttachment = async (req, res) => {
  try {
    ...
    console.error("🔥 Rename attachment error:", error.message, error.stack);
    res
      .status(500)
...
exports.deleteAttachment = async (req, res) => {
  try {
    ...
    console.error("🔥 Delete attachment error:", error.message, error.stack);
    res
      .status(500)
...
exports.getCourseBySlug = async (req, res) => {
  try {
    ...
    console.error("🔥 Get course error:", error.message, error.stack);
    res
      .status(500)
...
exports.getEnrolledCourseBySlug = async (req, res) => {
  try {
    ...
    console.error("🔥 Get enrolled course error:", error.message, error.stack);
    res
      .status(500)
      .json({ error: "Failed to fetch course", details: error.message });
  }
...
exports.getLessonsByCourse = async (req, res) => {
  try {
    ...
    console.error("🔥 Fetch lessons error:", error.message, error.stack);
    res
      .status(500)
...
exports.getAllCourses = async (req, res) => {
  try {
    ...
    console.error("🔥 Fetch all courses error:", error.message, error.stack);
    res
      .status(500)
...
module.exports = {
  ...
  renameAttachment: exports.renameAttachment,
  deleteAttachment: exports.deleteAttachment,
  getCourseBySlug: exports.getCourseBySlug,
  getEnrolledCourseBySlug: exports.getEnrolledCourseBySlug,
  getLessonsByCourse: exports.getLessonsByCourse,
  getTeacherCourses: exports.getTeacherCourses,
