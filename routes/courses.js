...
const authenticateToken = require("../middleware/authenticateToken");
const checkTeacherOrAdmin = require("../middleware/checkTeacherOrAdmin");
const courseController = require("../controllers/courseController"); // Import controller
...
router.post(
  ...
  courseController.createCourse // Fixed: Use imported controller function
);
...
router.get(
  "/:courseId/lessons",
  auth,
  courseController.getLessonsByCourse // Fixed: Use imported controller function
);
