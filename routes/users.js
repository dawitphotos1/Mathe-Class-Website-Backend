...
// New endpoint for fetching enrolled courses
router.get("/enrollments/my-courses", authMiddleware, async (req, res) => {
  try {
    const userId = req.user.id;
    ...
    const courses = enrollments.map((enrollment) => ({
      ...
      enrolledAt: enrollment.accessGrantedAt,
      status: enrollment.approved ? "approved" : "pending",
      progress: enrollment.progress || 0,
      thumbnail: `/thumbs/${enrollment.Course.slug}.jpg`,
    }));
